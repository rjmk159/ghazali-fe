...
const Home: NextPageWithLayout = () => {
  return (
    <>
      <Head title="About" description="Art is everyrging" />
      <Container className="about-row">
        <h1 className="main-title">About</h1>
        <p className="about-heading bg-effect">
          Ghazali Moinuddin is a renowned Painter and Prof. of Fine Arts at
          Jamia Millia Islamia, based in Delhi. He completed his BFA (Bachelor
          of Fine Arts) in 1999 from Jamia Millia Islamia and MFA (Master of
          Fine Arts) in 2001 from Jamia Millia Islamia.{" "}
        </p>
        <Spacer p={86} />
        ...
        <div className="row-fluid bg-effect">
          <div className="column-50">
            <p className="mw-700 ">
              ...
              are born out of a tube of acrylic and his deft fingers.
            </p>
          </div>
          <div className="column-50 ">
            <p className="p-gara">
              Recipient of many awards and recognitions, he has had solo and
        ...
        <div className="row-fluid">
          <div className="column-50 bg-effect">
            <p>
              ...
              beauty in a manner as if he were replicating what stood in front
              of him. But, in reality he reveals – “It has been ages since I
              have been to a hill station. All the 45 paintings have come
              through my imagination. Even when I am confined to a room
              surrounded by books and magazines, my mind transports me to a
              serene hill station where the beauty of Himalayas leaves me in a
              Trans”.
            </p>
          </div>
          <div className="column-50">
            <p className="p-gara bg-effect">
              In some of his works, he applies new possibilities directly,
              without any justification or a literary content. In these
              paintings pure forms take reign in their elementary capacity,
              completely visible in their stiff, vertical or horizontal seams
              and layers are the materials with which the compositions are
              rhythmically constructed at their chosen best.
            </p>
          </div>
        </div>
        <Spacer p={103} />
        ...
        <div className="row-fluid">
          <div className="about-quote bg-effect">
            ...
            <span className="p-small">
              He uses a fresh, firm yet spontaneous seeming stylization of the
              forms of nature in depth, and a symbolic content.
            </span>
          </div>
        </div>
              ...
              <ul>
                <li>
                  ...
                  <span className="about-row-content">
                    Qaus-E-Quzah: All India Fine Arts and Crafts Society, 1-Rafi
                    Marg New Delhi{" "}
                  </span>
                </li>
                <li>
                  ...
                  <span className="about-row-content">
                    Nuqoosh-E-Fitrat: Visual Arts Gallery India Habitate Center,
                    Lodi Road, New Delhi{" "}
                  </span>
                </li>
                <li>
                  ...
                  <span className="about-row-content">
                    Amwaaj-E-Takhayyul: MF Hussain Art Gallery, Jamia Millia
                    Islamia University, N. Delhi{" "}
                  </span>
                </li>
                {/*  */}
                <li>
                  ...
                  <span className="about-row-content">
                    "Kun Faya Koon”: Visual Art Gallery, India Habitat Center,
            ...
            <div className="column-50">
              ...
              <ul>
                <li>
                  ...
                  <span className="about-row-content">
                    Participated in Art Exhibition Celebrating Indian Languages
                    The Learning Curve at Twin Art Gallery, IGNCA, New Delhi.
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2017</span>
                  <span className="about-row-content">
                    Participated in Jaipur Kala Mahotsav Organized by Pratibha
                    Educational Development Research Society, Shilpgram, Jawahar
                    Kala Kendra, Jaipur.
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2017</span>
                  <span className="about-row-content">
                    Participated in National Art Exhibition Organized by Vidya
                    Institute of Fashion Technology, Meerut Uttar Pradesh,
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2016</span>
                  <span className="about-row-content">
                    Participated in India Art Festival, Nehru Center, Worli,
                    Mumbai{" "}
                  </span>
                </li>
                <li>
                  ...
                  <span className="about-row-content">
                    Participated in the India Art Festival, Nehru Center, Worli,
                    Mumbai
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2015</span>
                  <span className="about-row-content">
                    Participated in the Contemporary Art Exhibitions, at Lalit
                    Kala Academy, Ravindra Bhawan, in the cities of New Delhi,
                    Chennai and Bhopal.
                  </span>
                </li>
                <li>
                ...
                <li>
                  <span className="about-row-date">2012</span>
                  <span className="about-row-content">
                    Participated in the contemporary Art Exhibition at Rabindar
                    Bhawan Mandi House, New Delhi.
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2012</span>
                ...
                <li>
                  ...
                  <span className="about-row-content">
                    Participated in the Contemporary Art Exhibitions, at Lalit
                    Kala Academy, Ravindra Bhawan, New Delhi
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2010</span>
                ...
                <li>
                  ...
                  <span className="about-row-content">
                    Participated in a group show for flood affected people of
                    Bihar, organized by Modern School, Barakhamba Road, New
                    Delhi, in 2009.
                  </span>
                </li>
                <li>
                ...
                <li>
                  <span className="about-row-date">2008</span>
                  <span className="about-row-content">
                    Participated in the State Lalit Kala Academy Lucknow{" "}
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2008</span>
                  <span className="about-row-content">
                    Participated in the 3rd Indian contemporary miniature
                    painting and sculpture exhibition organized by Nav
                    Siddhartha Art Group at Lalit Kala Academy New Delhi
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="column-50">
              ...
              <ul>
                <li>
                  ...
                  <span className="about-row-content">
                    International Interview Published in We TV Arabia, Dubai,
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2017</span>
                  <span className="about-row-content">
                    Interview and Article published in India Today, Press Trust
                    of India,
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2014</span>
                  <span className="about-row-content">
                    Painting published in Star Week magazine, in the January
                    issue
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2014</span>
                  <span className="about-row-content">
                    Painting published in Glittering India magazine, in the
                    January issue
                  </span>
                </li>
                <li>
                ...
                <li>
                  <span className="about-row-date">2014</span>
                  <span className="about-row-content">
                    Painting published in Inside-Outside magazine
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2014</span>
                ...
                <li>
                  <span className="about-row-date">2012</span>
                  <span className="about-row-content">
                    Painting published in 'Media Opinion', a quarterly magazine
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2012</span>
                ...
                <li>
                  <span className="about-row-date">2009</span>
                  <span className="about-row-content">
                    Painting published in 'Women's' Era', a fortnightly
                    magazine, in the February
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="column-50">
              ...
              <ul>
                <li>
                  <span className="about-row-date">2016</span>
                  <span className="about-row-content">
                    Painting selected for display in the “Hall of Fame” of MSTF
                    museum for 57 OIC Countries, associated with UNOSSC, in
                    Tehran, Iran I.R.
                  </span>
                </li>
                <li>
                  <span className="about-row-date">2017</span>
                  <span className="about-row-content">
                    He received the Certificate of Appreciation in the Field of
                    People Leader by Darsgah Mughal Shahenshah Bahadur Shah
                    Zafar.
                  </span>
                </li>
                <li>
        ...
        <div className="find-collections">
          <p>
            His collections find place in the following prestigious places/homes
          </p>
          <ul>
            <li>
              ...
              <span className="find-collections-content">
                {" "}
                Cheazemi Haron, Deputy High Commissioner, Malaysian High
                Commission, at Chanaykya Puri, New Delhi.
              </span>
            </li>
            <li>
              <span className="find-collections-no">02</span>
              <span className="find-collections-content">
                Mohd. Eabin Basir, Counselor Malaysian Embassy, at Chanaykya
                Puri, New Delhi
              </span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className="find-collections-content">
                With the ex- Ministry of External Affairs - Salman Khursheed
              </span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className="find-collections-content">
                Paintings presented to the business tycoons of Dubai invited as
                guests on the TV Programme - “A Day with a Tycoon”, by ZEE TV,
                Dubai
              </span>
            </li>
          </ul>
        ...
        <div className="awards-exp">
          <div className="row-fluid">
            <div className="column-50" />
            <div className="column-50">
              <div className="about-row-title">university appearances</div>
              <ul>
                <li>
                  <span className="about-row-date">2008</span>
                  <span className="about-row-content">
                    He assisted in an Educational Tour of the whole Department
                    to Ajanta and Ellora (Aurangabad).
                  </span>
                </li>
                <li>
                  <span className="about-row-date">1996</span>
                  <span className="about-row-content">
                    He assisted in the University Decoration Committee during
                    Foundation Day, in Jamia.
                  </span>
                </li>
                <li>
